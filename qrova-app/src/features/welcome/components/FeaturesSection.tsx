...
const BADGE_STYLES: Record<BadgeVariant, string> = {
  gratis: "bg-success-light text-success-text",
  "con-cuenta": "bg-brand-light text-brand-text",
  todas: "bg-surface-muted text-fg-muted",
};
...
const FeatureCard = ({
  ...
  <article className="flex flex-col gap-4 bg-surface-raised border border-stroke-subtle rounded-2xl p-6 shadow-sm">
    ...
    <div className="flex flex-col gap-2">
      <h3 className="text-fg-primary font-bold text-lg leading-snug">{title}</h3>
